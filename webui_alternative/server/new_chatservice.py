...
def sentiment():
    ...
    for word in blob.words:
        if word in tsne:
            ...
            x,y,pos = random.random(), random.random(), random.randrange(21)
        word_descriptions.append( {"word": word, "prob": "{0:.4f}".format(probability), "x": x, "y": y, "wordtype": pos }  )
